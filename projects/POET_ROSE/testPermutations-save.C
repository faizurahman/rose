...
lower_level_relax ( MulticoreArray < T > & array, MulticoreArray < T > & old_array )
   {
     ...
     ( ( array . get_tableBasedDistribution ( ) == old_array . get_tableBasedDistribution ( ) ) ? static_cast < void > ( 0 ) : __assert_fail ( "array.get_tableBasedDistribution() == old_array.get_tableBasedDistribution()", "testPermutations.C", 89, __PRETTY_FUNCTION__ ) );
      ...
      for (int core = 0; core < numberOfCores; core++)
         {
           ...
           Core<float>::index_set_type (*coreArrayNeighborhoodSizes)[3] = cur_core->coreArrayNeighborhoodSizes_2D;
           ...
           #pragma omp for 
           for (int k = 1;k<(local_size2-1);k++) 
             for (int j = 1;j<(local_size1-1);j++) 
               for (int i = 1;i<(arraySizeX-1);i++) 
                 old_arraySection[local_index3D(i,j,k,local_size0,local_size1)] = arraySection[local_index3D(i-1,j-1,k-1,local_size0,local_size1)]+arraySection[local_index3D(i+1,j-1,k-1,local_size0,local_size1)]+arraySection[local_index3D(i-1,j+1,k-1,local_size0,local_size1)]+arraySection[local_index3D(i+1,j+1,k-1,local_size0,local_size1)]+arraySection[local_index3D(i-1,j-1,k+1,local_size0,local_size1)]+arraySection[local_index3D(i+1,j-1,k+1,local_size0,local_size1)]+arraySection[local_index3D(i-1,j+1,k+1,local_size0,local_size1)]+arraySection[local_index3D(i+1,j+1,k+1,local_size0,local_size1)]/8.0;
           ...
           if (local_size1 > 1)
             {
               ...
               { 
                 ...
                 // ***** | ****** | *****
                 #pragma omp for 
                 for (int k = 1;k<(-1+local_size2);k++) 
                   for (int i = 1;i<(-1+arraySizeX);i++) 
           ...
           if (local_size2 > 1)
             {
               ...
               { 
                 ...
                 for (int j = 1;j<(-1+local_size1);j++) 
                   for (int i = 1;i<(-1+arraySizeX);i++) 
                     old_arraySection[local_index3D(i,j,0,local_size0,local_size1)] = arraySection[local_index3D(1+i,1+j,1,local_size0,local_size1)]+(arraySection[local_index3D(-1+i,1+j,1,local_size0,local_size1)]+(arraySection[local_index3D(1+i,-1+j,1,local_size0,local_size1)]+(arraySection[local_index3D(-1+i,-1+j,1,local_size0,local_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(1+i,1+j,-1+left_size2,left_size0,left_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(-1+i,1+j,-1+left_size2,left_size0,left_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(-1+i,-1+j,-1+left_size2,left_size0,left_size1)]+arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(1+i,-1+j,-1+left_size2,left_size0,left_size1)]))))))/8.0; 
               }
               if (right_size2>0 &&
                   bounaryCore[0][1] == false)
               {
                 ...
                 for (int j = 1;j<(-1+local_size1);j++) 
                   for (int i = 1;i<(-1+arraySizeX);i++) 
                     old_arraySection[local_index3D(i,j,-1+local_size2,local_size0,local_size1)] = arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(1+i,1+j,0,right_size0,right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(-1+i,1+j,0,right_size0,right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(1+i,-1+j,0,right_size0,right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(-1+i,-1+j,0,right_size0,right_size1)]+(arraySection[local_index3D(1+i,1+j,-2+local_size2,local_size0,local_size1)]+(arraySection[local_index3D(-1+i,1+j,-2+local_size2,local_size0,local_size1)]+(arraySection[local_index3D(-1+i,-1+j,-2+local_size2,local_size0,local_size1)]+arraySection[local_index3D(1+i,-1+j,-2+local_size2,local_size0,local_size1)]))))))/8.0; 
               }
             }
                    ...
                    right_size2>0)
              {
                 ...
                 for (int j = 1;j<(-1+local_size1);j++) 
                   for (int i = 1;i<(-1+arraySizeX);i++) 
                     old_arraySection[local_index3D(i,j,0,local_size0,local_size1)] = arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(1+i,1+j,0,right_size0,right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(-1+i,1+j,0,right_size0,right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(1+i,-1+j,0,right_size0,right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(-1+i,-1+j,0,right_size0,right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(1+i,1+j,-1+left_size2,left_size0,left_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(-1+i,1+j,-1+left_size2,left_size0,left_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(-1+i,-1+j,-1+left_size2,left_size0,left_size1)]+arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(1+i,-1+j,-1+left_size2,left_size0,left_size1)]))))))/8.0;
              }
                    ...
                    if (left_size0 > 0)
                     {
                        if (local_size1 > 1)
                 	 {
                 	   ...
                 	   if (bounaryCore[1][0] == false)
                              ...
                              #pragma omp for 
                              for (int i = 1;i<(-1+arraySizeX);i++) 
                                old_arraySection[local_index3D(i,0,0,local_size0,local_size1)] = arraySection[local_index3D(1+i,1,1,local_size0,local_size1)]+(arraySection[local_index3D(-1+i,1,1,local_size0,local_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(1+i,-1+left_size0,1,left_size0,left_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(-1+i,-1+left_size0,1,left_size0,left_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][1]][otherCore_index3D(1+i,1,-1+upper_size1,upper_size0,upper_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][1]][otherCore_index3D(-1+i,1,-1+upper_size1,upper_size0,upper_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][0]][otherCore_index3D(-1+i,-1+left_size0,-1+upper_size1,upper_left_size0,upper_left_size1)]+arraySectionPointers[coreArrayNeighborhoodLinearized[0][0]][otherCore_index3D(1+i,-1+left_size0,-1+upper_size1,upper_left_size0,upper_left_size1)]))))))/8.0; 
                 	   // Lower corner
                 	   if (bounaryCore[1][1] == false)
                              ...
                              #pragma omp for 
                              for (int i = 1;i<(-1+arraySizeX);i++) 
                                old_arraySection[local_index3D(i,0,-1+local_size1,local_size0,local_size1)] = arraySectionPointers[coreArrayNeighborhoodLinearized[2][1]][otherCore_index3D(1+i,1,0,lower_size0,lower_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][1]][otherCore_index3D(-1+i,1,0,lower_size0,lower_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][0]][otherCore_index3D(1+i,-1+left_size0,0,lower_left_size0,lower_left_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][0]][otherCore_index3D(-1+i,-1+left_size0,0,lower_left_size0,lower_left_size1)]+(arraySection[local_index3D(1+i,1,-2+local_size1,local_size0,local_size1)]+(arraySection[local_index3D(-1+i,1,-2+local_size1,local_size0,local_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(-1+i,-1+left_size0,-2+local_size1,left_size0,left_size1)]+arraySectionPointers[coreArrayNeighborhoodLinearized[1][0]][otherCore_index3D(1+i,-1+left_size0,-2+local_size1,left_size0,left_size1)]))))))/8.0; 
                            }
                        else if (local_size1 == 1)
                           ...
                           #pragma omp for 
                           for (int i = 1;i<(-1+arraySizeX);i++) 
                             old_arraySection[local_index3D(i,0,0,local_size0,local_size1)] = arraySectionPointers[coreArrayNeighborhoodLinearized[2][1]][otherCore_index3D(1+i,1,0,lower_size0,lower_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][1]][otherCore_index3D(-1+i,1,0,lower_size0,lower_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][0]][otherCore_index3D(1+i,-1+left_size0,0,lower_left_size0,lower_left_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][0]][otherCore_index3D(-1+i,-1+left_size0,0,lower_left_size0,lower_left_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][1]][otherCore_index3D(1+i,1,-1+upper_size1,upper_size0,upper_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][1]][otherCore_index3D(-1+i,1,-1+upper_size1,upper_size0,upper_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][0]][otherCore_index3D(-1+i,-1+left_size0,-1+upper_size1,upper_left_size0,upper_left_size1)]+arraySectionPointers[coreArrayNeighborhoodLinearized[0][0]][otherCore_index3D(1+i,-1+left_size0,-1+upper_size1,upper_left_size0,upper_left_size1)]))))))/8.0; 
                      }
                    else
                      {
                    ...
                    if (right_size0 > 0)
                     {
                        if (local_size1 > 1)
                 	 {
                 	   ...
                 	   if (bounaryCore[1][0] == false)
                              ...
                              #pragma omp for 
                              for (int i = 1;i<(-1+arraySizeX);i++) 
                                old_arraySection[local_index3D(i,-1+local_size0,0,local_size0,local_size1)] = arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(1+i,0,1,right_size0,right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(-1+i,0,1,right_size0,right_size1)]+(arraySection[local_index3D(1+i,-2+local_size0,1,local_size0,local_size1)]+(arraySection[local_index3D(-1+i,-2+local_size0,1,local_size0,local_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][2]][otherCore_index3D(1+i,0,-1+upper_size1,upper_right_size0,upper_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][2]][otherCore_index3D(-1+i,0,-1+upper_size1,upper_right_size0,upper_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][1]][otherCore_index3D(-1+i,-2+local_size0,-1+upper_size1,upper_size0,upper_size1)]+arraySectionPointers[coreArrayNeighborhoodLinearized[0][1]][otherCore_index3D(1+i,-2+local_size0,-1+upper_size1,upper_size0,upper_size1)]))))))/8.0; 
                 	   // Lower corner
                 	   if (bounaryCore[1][1] == false)
                              // Lower right corner
                              // ***** | ****** | *****
                              ...
                              #pragma omp for 
                              for (int i = 1;i<(-1+arraySizeX);i++) 
                                old_arraySection[local_index3D(i,-1+local_size0,-1+local_size1,local_size0,local_size1)] = arraySectionPointers[coreArrayNeighborhoodLinearized[2][2]][otherCore_index3D(1+i,0,0,lower_right_size0,lower_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][2]][otherCore_index3D(-1+i,0,0,lower_right_size0,lower_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][1]][otherCore_index3D(1+i,-2+local_size0,0,lower_size0,lower_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][1]][otherCore_index3D(-1+i,-2+local_size0,0,lower_size0,lower_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(1+i,0,-2+local_size1,right_size0,right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[1][2]][otherCore_index3D(-1+i,0,-2+local_size1,right_size0,right_size1)]+(arraySection[local_index3D(-1+i,-2+local_size0,-2+local_size1,local_size0,local_size1)]+arraySection[local_index3D(1+i,-2+local_size0,-2+local_size1,local_size0,local_size1)]))))))/8.0; 
                            }
                        else if (local_size1 == 1)
                           // Case of upper and lower corners are the same point
                           // ***** | ****** | *****
                           ...
                           #pragma omp for 
                           for (int i = 1;i<(-1+arraySizeX);i++) 
                             old_arraySection[local_index3D(i,-1+local_size0,0,local_size0,local_size1)] = arraySectionPointers[coreArrayNeighborhoodLinearized[2][2]][otherCore_index3D(1+i,0,0,lower_right_size0,lower_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][2]][otherCore_index3D(-1+i,0,0,lower_right_size0,lower_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][1]][otherCore_index3D(1+i,-2+local_size0,0,lower_size0,lower_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][1]][otherCore_index3D(-1+i,-2+local_size0,0,lower_size0,lower_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][2]][otherCore_index3D(1+i,0,-1+upper_size1,upper_right_size0,upper_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][2]][otherCore_index3D(-1+i,0,-1+upper_size1,upper_right_size0,upper_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][1]][otherCore_index3D(-1+i,-2+local_size0,-1+upper_size1,upper_size0,upper_size1)]+arraySectionPointers[coreArrayNeighborhoodLinearized[0][1]][otherCore_index3D(1+i,-2+local_size0,-1+upper_size1,upper_size0,upper_size1)]))))))/8.0; 
                      }
                    else
                      {
                        printf ("We don't support the size on the adjacent being zero! \n");
  		   ...
  		   if (bounaryCore[0][0] == false && bounaryCore[0][1] == false && bounaryCore[1][0] == false && bounaryCore[1][1] == false)
  		     {
  		       if (left_size0 > 0 && right_size0 > 0)
                            ...
                            #pragma omp for 
                            for (int i = 1;i<(-1+arraySizeX);i++) 
                              old_arraySection[local_index3D(i,0,-1+local_size0,local_size0,local_size1)] = arraySectionPointers[coreArrayNeighborhoodLinearized[2][2]][otherCore_index3D(1+i,0,0,lower_right_size0,lower_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][2]][otherCore_index3D(-1+i,0,0,lower_right_size0,lower_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][2]][otherCore_index3D(1+i,-1+upper_size1,0,upper_right_size0,upper_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][2]][otherCore_index3D(-1+i,-1+upper_size1,0,upper_right_size0,upper_right_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][0]][otherCore_index3D(1+i,0,-1+left_size0,lower_left_size0,lower_left_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[2][0]][otherCore_index3D(-1+i,0,-1+left_size0,lower_left_size0,lower_left_size1)]+(arraySectionPointers[coreArrayNeighborhoodLinearized[0][0]][otherCore_index3D(-1+i,-1+upper_size1,-1+left_size0,upper_left_size0,upper_left_size1)]+arraySectionPointers[coreArrayNeighborhoodLinearized[0][0]][otherCore_index3D(1+i,-1+upper_size1,-1+left_size0,upper_left_size0,upper_left_size1)]))))))/8.0; 
  		     }
  	     }
...
// This is the higher level implementation attractive for users (or the even high level array notation, but not supported with this abstraction).
              high_level_relax< float  > (tmp_array1,old_tmp_array1);
              high_level_relax< float  > (tmp_array2,old_tmp_array2);
#else
#endif
#if 0
// Output the result
...
// Make sure that the results are the same.
              tmp_array1 == tmp_array2?((void )0) : __assert_fail("tmp_array1 == tmp_array2","testPermutations.C",264,__PRETTY_FUNCTION__);
#endif
#if 0
